...
const  ResultsListPage = () => {
  const renderRow = (item:Results)=>(   <tr  key={item.id}
  ...
  >
    ...
    <td className="flex flex-col md:flex-row md:table-cell">{item.student}</td>
    <td className="flex flex-col md:flex-row md:table-cell">{item.type}</td>
    <td className="flex flex-col md:flex-row md:table-cell">{item.score}</td>
